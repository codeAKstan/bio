                ...
                <div className="grid h-svh grid-cols-12 items-end gap-x-4 pb-12 pt-8">
                  ...
                  <div className="col-span-12">
                    <div className="font-serif leading-[1.05] tracking-tight text-[clamp(20px,4.4vw,40px)]">
                      Treena E. Reynolds’ debut, Ticklish Cloud, illustrated by Karissa Feese, is a playful book
                      designed for ages 3–7. It delivers a mix of humor and rhythm that makes it perfect for
                      bedtime, group reading, or solo exploration by early readers.
                    </div>
                    <div className="mt-6 flex">
                      <Link
                        ...
                        className="w-full rounded-full bg-white/10 px-5 py-2 text-sm font-medium text-white ring-1 ring-white/15 backdrop-blur transition-colors hover:bg-white/15"
                      >
                        View book
                      </Link>
                    </div>
                ...
                <div className="grid h-svh grid-cols-12 gap-x-4 py-10">
                  <div className="col-span-12">
                    ...
                    <div className="mt-6 max-w-md text-xs leading-relaxed text-white/80">
                      The story is fun, but it also works as a learning tool. Short text supports early reading
                      skills. Illustrations guide comprehension. Humor keeps attention locked in. It’s a storybook
                      that works as both entertainment and early literacy support.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="hidden sm:block">
          <div className="grid h-svh grid-cols-12 items-end gap-x-4 sm:gap-x-6 pb-12 pt-8 sm:pb-16 sm:pt-10">
            <div className="col-span-12 flex items-center justify-center md:col-span-7 md:justify-start">
              <h2 className="font-serif leading-none tracking-tight text-[clamp(56px,16vw,200px)]">Book</h2>
            </div>
            <div className="col-span-12 md:col-span-5">
              <div className="font-serif leading-[1.05] tracking-tight text-[clamp(20px,4.4vw,40px)]">
                Treena E. Reynolds’ debut, Ticklish Cloud, illustrated by Karissa Feese, is a playful book designed
                for ages 3–7. It delivers a mix of humor and rhythm that makes it perfect for bedtime, group
                reading, or solo exploration by early readers.
              </div>
          ...
          <div className="relative grid h-svh grid-cols-12 gap-x-4 sm:gap-x-6 py-10 sm:py-14">
            ...
            <div className="col-span-12 md:col-span-5">
              ...
              <div className="h-px w-full bg-white/25" />
              <div className="mt-6 max-w-md text-xs leading-relaxed text-white/80">
                The story is fun, but it also works as a learning tool. Short text supports early reading skills.
                Illustrations guide comprehension. Humor keeps attention locked in. It’s a storybook that works as
                both entertainment and early literacy support.
              </div>
            </div>
          </div>
        </div>
