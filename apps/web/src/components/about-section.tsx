      ...
      <div className="mx-auto h-full w-full max-w-7xl px-4 sm:px-6">
        <div className="sm:hidden">
          <div className="sticky top-0 h-svh">
            <div className="h-full overflow-y-auto overscroll-contain snap-y snap-mandatory text-white">
              <div className="snap-start">
                <div className="grid h-svh grid-cols-12 grid-rows-[auto_1fr_auto] gap-x-4 py-8">
                  <div className="col-span-12 flex flex-col gap-4 text-[11px] tracking-wide text-white/80">
                    <div className="leading-relaxed" />
                    <div className="invisible flex gap-6 uppercase">
                      <div className="leading-relaxed">
                        <Link
                          href="#contact"
                ...
                <div className="grid h-svh grid-cols-12 gap-x-4 py-10">
                  <div className="col-span-12">
                    <div className="max-w-2xl font-serif leading-[1.05] tracking-tight text-[clamp(22px,4.6vw,44px)]">
                      Treena E. Reynolds is a professional coach and author who blends important lessons with
                      real-life advice, aiming to help people grow. Her work speaks to everyday challenges and
                      small wins. With strong academic training and years of experience, she has helped many find
                      clarity and confidence. Now she brings that same vision to children’s books, blending sharp
                      detail with warmth, humor, and heart.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="hidden sm:block">
          <div className="grid h-svh grid-cols-12 grid-rows-[auto_1fr_auto] gap-x-4 sm:gap-x-6 py-8 sm:py-10 text-white">
            <div className="col-span-12 flex flex-col gap-4 text-[11px] tracking-wide text-white/80 sm:flex-row sm:items-start sm:justify-between sm:text-xs">
              ...
              <div className="invisible flex gap-6 uppercase sm:visible sm:gap-10">
                <div className="leading-relaxed">
                  <Link
                    href="#contact"
                    className="text-white/70"
          ...
          <div className="relative grid h-svh grid-cols-12 gap-x-4 sm:gap-x-6 py-10 sm:py-14 text-white">
            ...
            <div className="col-span-12 md:col-span-7 md:pl-6">
              <div className="max-w-2xl font-serif leading-[1.05] tracking-tight text-[clamp(22px,4.6vw,44px)]">
                Treena E. Reynolds is a professional coach and author who blends important lessons with real-life
                advice, aiming to help people grow. Her work speaks to everyday challenges and small wins. With
                strong academic training and years of experience, she has helped many find clarity and confidence.
                Now she brings that same vision to children’s books, blending sharp detail with warmth, humor, and
                heart.
              </div>
            </div>
