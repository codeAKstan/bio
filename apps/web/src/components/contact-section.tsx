             ...
             <div className="relative mt-2 min-h-[360px] max-w-2xl">
               <div
                 className={`transition-all duration-500 ease-out ${
                   mode === "intro" ? "opacity-100 translate-y-0" : "pointer-events-none opacity-0 -translate-y-2"
                 }`}
               >
               ...
               <div
                 className={`absolute inset-0 transition-all duration-500 ease-out ${
                   mode === "form" ? "opacity-100 translate-y-0" : "pointer-events-none opacity-0 translate-y-2"
                 }`}
               >
                 <button
                   type="button"
